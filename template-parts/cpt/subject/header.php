...
$apcom_subject_website = get_post_meta( get_the_ID(), 'official_website' );
?>
	...
	<dl class="page__meta meta">
		...
		if ( '' !== $apcom_subject_website[0] ) {
			...
			<div class="meta__item meta__item--has-icon meta__website">
				...
				<dd class="meta__description">
					<a href="<?php echo esc_url( $apcom_subject_website[0] ); ?>"><?php echo esc_url( $apcom_subject_website[0] ); ?></a>
				</dd>
			</div>
			<?php
		}
