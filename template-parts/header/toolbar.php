...
<div class="header__toolbar toolbar" id="toolbar">
	<div class="toolbar__item toolbar__item--search" id="toolbar__search" title="<?php esc_attr_e( 'Search', 'APCom' ); ?>">
		<input type="checkbox" name="search__checkbox" id="search__checkbox" class="toolbar__checkbox toolbar__checkbox--toggle">
		<label for="search__checkbox" class="toolbar__btn btn btn--round">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" class="btn__icon btn__icon--search" aria-hidden="true">
