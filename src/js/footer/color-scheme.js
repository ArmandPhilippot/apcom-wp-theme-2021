...
function getLightThemeIcon() {
	...
	sunIcon.classList.add( 'toolbar__icon', 'toolbar__icon--light' );
	sunIcon.innerHTML =
...
function getDarkThemeIcon() {
	...
	moonIcon.classList.add( 'toolbar__icon', 'toolbar__icon--dark' );
	moonIcon.innerHTML =
...
function getDarkThemeLabel() {
	...
	span.classList.add( 'toolbar__label--light', 'screen-reader-text' );
...
function getLightThemeLabel() {
	...
	span.innerHTML = label;
	span.classList.add( 'toolbar__label--dark', 'screen-reader-text' );
...
function createSwitchThemeButton() {
	...
	toggleDiv.classList.add( 'toolbar__item', 'themes' );
	...
	switchButton.classList.add( 'toolbar__label', 'toolbar__btn' );
	...
	toolbar.insertBefore( toggleDiv, toolbar.firstChild );
}
