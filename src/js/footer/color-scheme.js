...
function getDarkThemeLabel() {
	let span = document.createElement('span');
	let label = color_scheme_vars.lightThemeText;
...
function getLightThemeLabel() {
	let span = document.createElement('span');
	let label = color_scheme_vars.darkThemeText;
...
function createSwitchThemeButton() {
	let preferredColorScheme = getThemePreference();
	let toolsBar = document.getElementById('tools');
	let toolsBarFirstChild = toolsBar.firstChild;
