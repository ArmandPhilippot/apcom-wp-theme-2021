...
Prism.plugins.toolbar.registerButton( 'switch-theme', function( env ) {
	...
	const lightSpanTxt = document.createElement( 'span' );
	const lightSpanIcon = document.createElement( 'span' );
	const darkSpanTxt = document.createElement( 'span' );
	const darkSpanIcon = document.createElement( 'span' );
	const lightThemeTxt = prism_vars.lightThemeText;
	const darkThemeTxt = prism_vars.darkThemeText;
	const moonIcon =
	...
	function updateButtonContent() {
		const codeBlocksButton = document.querySelectorAll( '.prism-theme__btn' );
		const colorScheme = getPreference();
